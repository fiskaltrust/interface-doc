...
| **Field name**            | **Data type** | **Default Value Mandatory Field** | **Description**                                                                                         | **Version** |
|---------------------------|---------------|-----------------------------------|---------------------------------------------------------------------------------------------------------|-------------|
| `UserId` | `string`      | optional | Send via `ftReceiptCaseData` in JSON format. To send, please add the key value pair `UserId` e.g. `"ftReceiptCaseData":"{ ..., "UserId": "U192", ... }"`. If not sent, the ft will automatically generate a User-ID (hash) deducted from `cbUser` | 1.3 |
...
| `ProductGroupId` | `string`      | optional | Send via `ftChargeItemCaseData` in JSON format. To send, please add the key value pair `ProductGroupId` e.g. `"ftChargeItemCaseData":"{ ..., "ProductGroupId":192, ... }"`. If not sent, the ft will automatically generate an ID (CRC32 hash) deducted from `ftChargeItem.ProductGroup` | 1.3 |
...
| `MoneyGroupId` | `string` | optional | Send via `ftPayItemCaseData` in JSON format. To send, please add the key value pair `MoneyGroupId` e.g. `"ftPayItemCaseData":"{ ..., "MoneyGroupId":192, ... }"`. If not sent, the ft will automatically generate an ID (CRC32 hash) deducted from `ftPayItem.MoneyGroup` | 1.3 |
