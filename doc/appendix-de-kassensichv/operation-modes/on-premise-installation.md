...
| [Cryptovision Hardware-TSE](SCD/cryptovision.md) | Hardware<br />microSD | **certified**          | **not needed**              | 128        | **supported**                          | **supported**                                                | not supported                          |
...
| [Diebold-Nixdorf Hardware-TSE](SCD/diebold-nixdorf.md) | Hardware<br />USB Type A | **certified**          | **not needed**              |                                         | **supported**                          | **supported**                                                | not supported                          |
| [Epson Hardware-TSE](SCD/epson.md) | Hardware<br />USB Type A, microSD | **certified** | **not needed**              |                                         | **supported**                          | **supported**                                                | not supported                          |
...
| [Swissbit Hardware-TSE](SCD/swissbit.md) | Hardware<br />USB Type A, SD, microSD | **certified** | **not needed** |                                         | **supported**                          | **supported**                                                | **supported**                          |
