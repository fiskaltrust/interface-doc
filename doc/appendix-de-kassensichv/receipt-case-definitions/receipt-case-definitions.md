...
Examples for these cases can be found in our [Postman sample collection](https://middleware-samples.docs.fiskaltrust.cloud/).

### Returnable
Income from returnables (DE: _Pfand_) and their return with settlement of the pledged amount (DE: _Pfandrückzahlung_) are processes with DSFinV-K requirements. 
