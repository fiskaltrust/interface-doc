...
| `ftReceiptCase`              | `Int64`               | 0<br />mandatory                           | Type of business transaction according to the [reference table](../reference-tables/reference-tables.md#t-service-status-ftstate-22) in the appendix. It is used to choose the right processing logic.                                                                                                                                            | 0-             |
...
The sum of `ftPayItems` and the sum of `ftChargeItems`should be equal except for very specific cases. If that is not the case a warning will be returned.
