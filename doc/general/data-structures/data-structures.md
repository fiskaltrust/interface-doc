...
| `ftReceiptCase`              | `Int64`               | 0<br />mandatory                           | Type of business transaction ac-cording to the [reference table](../reference-tables/reference-tables.md#_Type_of_Receipt:) in the appendix. It is used to choose the right processing logic.                                                                                                                                                                                             | 0-             |
