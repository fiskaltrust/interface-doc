...
The details of fields supported by this data structure are outlined in <span class="underline">table <!-- TODO: table references --> 3</span> below. The field fiskaltrust receipt case (ftReceiptCase) is of the highest importance for the correct processing of the receipt. This field defines the receipt type, determines if the receipt has to be secured accordingly to the national law, and establishes the way to calculate the correct values for each national counter.
...
| `ftReceiptCase`              | `Int64`               | 0<br />mandatory                           | Type of business transaction ac-cording to the [reference table <!-- TODO: table references -->](../reference-table <!-- TODO: table references -->s/reference-table <!-- TODO: table references -->s.md#_Type_of_Receipt:) in the appendix. It is used to choose the right processing logic.                                                                                                                                                                                             | 0-             |
...
The details of fields supported by this data structure are outlined in table <!-- TODO: table references --> 5 below. The ftChargeItemCase field is particularly important for the correct processing of the receipt. A reference table for the supported values can be found in the appendix.
