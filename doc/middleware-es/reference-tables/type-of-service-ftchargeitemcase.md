...
| -------------------- | -------------- | ---------------------- |
| `0` | **Unknown type of service for ES**<br />With the help of the VAT-rates table saved within fiskaltrust.SecurityMechanisms. | 1.3.45  |
...
| `8` | **Not Taxable**<br />For processing, see (`0x4553000000000001`) | 1.3.45 |
