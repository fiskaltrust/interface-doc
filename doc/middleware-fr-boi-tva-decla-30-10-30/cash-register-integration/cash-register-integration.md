...
The action journal request call is type 1, and will respond with a list of entries. If one or more entries has their "Message" field starting by "Code 90", the cash register must send a Technical Event Log receipt request to the middleware including : "ftReceiptCaseData" : "{\"Code\": \"90\", \"Message\": \"Detection of an integrity flaw in secured data or a tax archive\"}"
