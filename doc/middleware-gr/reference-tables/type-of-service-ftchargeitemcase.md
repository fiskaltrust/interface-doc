...
| -------------------- | -------------- | ---------------------- |
| `0` | **Unknown type of service for GR**<br />With the help of the VAT-rates table saved within fiskaltrust.SecurityMechanisms. | 1.3.45  |
...
| `8` | **Not Taxable**<br />For processing, see (`0x4752000000000001`) | 1.3.45 |
...
| **Value**            | **Description**                                                                                        | **Spec. for Greek reg.** | **Middleware Version** |
| -------------------- | -------------- |  -------------- | ---------------------- |
...
| `30` | **Exempt**<br /> 3x| *GR (N4) marker mandatory<br />[30] exempt | 1.3.45  |
