...
Expand-Archive "./tools/DocFxChapterNumbers.zip" -DestinationPath "./tools/DocFxChapterNumbers"

Move-Item doc doc_prev
.\tools\DocFxChapterNumbers\DocFxChapterNumbers.exe doc_prev doc --force